...
},{"./AlbumApp.jsx":151,"react":148}],150:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
module.exports = React.createClass({displayName: 'exports',
	render: function () {
		return (
			React.createElement("div", {class: "row top-buffer", id: this.props.albumid}, 
				React.createElement("span", {class: "col-md-6"}, this.props.title), 
				React.createElement("span", {class: "col-md-1"}, React.createElement("a", {class: "btn edit", href: 'albums/' + this.props.id}, "Edit")), 
				React.createElement("span", {class: "col-md-1"}, 
					React.createElement("input", {'data-id': this.props.albumid, value: "delete album", name: 'deletebuttonalbum' + this.props.albumid, id: 'deletebuttonalbum' + this.props.albumid, class: "btn delete"})
				)
			)
		)
	}
...
},{"./AlbumList.jsx":152,"jquery":2,"react":148}],152:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
...
module.exports = React.createClass({displayName: 'exports',
	render: function () {
		...
		return (
			React.createElement("div", {class: "albumlist"}, 
				albums
			)
		)
	}
});
},{"./Album.jsx":150,"react":148}]},{},[149,150,151,152]);
