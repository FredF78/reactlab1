...
},{"./src":161}],150:[function(require,module,exports){
'use strict';
...
},{"./index":161,"./utils":165}],159:[function(require,module,exports){
var _ = require('./utils'),
...
},{"./Keep":152,"./index":161,"./utils":165}],160:[function(require,module,exports){
var _ = require('./utils'),
    Reflux = require('./index'),
    Keep = require('./Keep'),
    allowed = {preEmit:1,shouldEmit:1},
...
},{"./Keep":152,"./bindMethods":157,"./index":161,"./utils":165}],161:[function(require,module,exports){
...
},{"./index":161}],164:[function(require,module,exports){
var Reflux = require('./index');
...
},{"./index":161}],165:[function(require,module,exports){
/*
	...
	render: function () {
		if (this.props.albumData) {
			var albums = this.props.albumData.map(function (album) {
				return (
					React.createElement(Album, {id: album.id, name: album.name}
					)
				);
			});
		} else {
